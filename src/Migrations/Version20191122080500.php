 ...
 */
final class Version20191122080500 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE academy ADD academy_description VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE city ADD city_address VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE academy DROP academy_description');
